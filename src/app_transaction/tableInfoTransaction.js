            ...
            <>
                ...
                <Table responsive borderless size="sm" className={this.props.lotshare === 'modalbuy' || this.props.lotshare === 'modalSell' || this.props.lotshare === 'modalamend' ? "text-white d-border-table bg-dark-grey card-112 mb-1" : "text-white d-border-table bg-dark-grey card-112 mb-2"}>
                    ...
                    <tr>
                        ...
                        <td className="no-wrap d-border-tr-gray text-right py-1">13,000</td>
                        <td className="no-wrap bg-gray-tradding d-border-tr-black py-1">Avg.</td>
                        <td className="no-wrap d-border-tr-gray text-danger text-right py-1">12,639.92</td>
                        <td className="no-wrap bg-gray-tradding d-border-tr-black py-1">F. Sell</td>
                        <td className="no-wrap d-border-tr-gray text-right py-1">825.5 M</td>
                    </tr>
                    <tr className={
                        (
                            this.props.lotshare === 'buyPage' ||
                            this.props.lotshare === 'modalbuy' ||
                            this.props.lotshare === 'modalamend' || 
                            this.props.lotshare === 'modalSell'
                        ) ? "" : "d-none"}>
                        <td className="no-wrap bg-gray-tradding py-1">IEP</td>
                        <td className="no-wrap text-right text-success py-1">12,845</td>
                        <td className="no-wrap bg-gray-tradding py-1">IEV</td>
                        <td className="no-wrap text-danger text-right py-1">443</td>
