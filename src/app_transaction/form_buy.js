                        ...
                        <td className="py-0">
                            <div className="row py-form mb-0">
                                ...
                                <div className="col-sm-12 row">
                                    ...
                                    <div className="col-sm-10 mr-0 pr-0 f-15 d-none">
                                        <div className="pb-0 text-form">
                                            <b>
                                            <i className="fa fa-info-circle text-warning"></i>
                                                &nbsp; Bancrupty filing against the company
                                            </b>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <tr>
                        <td className="py-0">
                            <div className="row">
                                ...
                                <div className="col-sm-4 text-center align-middle align-self-center">
                                    <Button size="sm" className="btn btn-lg btn-danger col-sm-8" onClick={( 1 < 0 ) ?this.buttonClickPIN:this.handleRestrict}>
