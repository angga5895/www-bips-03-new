                                            ...
                                            props.activeInstance === e ?
                                                ...
                                                e.instanceName.search('Invboard') >= 0 ?
                                                    e.instanceName.search('tradePL') >= 0?
                                                        'active col-mn-7 click-pointer text-center'
                                                        :
                                                        'active col-mn-7 click-pointer d-border-right text-center bg-blue-white'
                                                    :

                                                    e.instanceName.search('stock') >= 0 ?
                                                        e.instanceName.search('stockSpecial') >= 0?
                                                        ...
                                                        e.instanceName.search('StatistikPage') >= 0 ?
                                                            ...
                                                            e.instanceName.search('Chat') >= 0 ?
                                                                ...
                                                                e.instanceName.search('automaticO') >= 0 ?
                                                                    ...
                                                                    e.instanceName.search('EsbnTrans') >= 0 ?
                                                                        e.instanceName.search('EsbnTransHistorical') >= 0 ?
                                                                            'active col-sm-6 click-pointer text-center bg-blue-white'
                                                                            :
                                                                            'active col-sm-6 click-pointer text-center d-border-right bg-blue-white'
                                                                        :
                                                                        ...
                                                                        trademore !== '' ?
                                                                            trademore === 'manual' ?
                                                                                ...
                                                                                e.instanceName.search('Aut') >= 0 ?
                                                                                    ...
                                                                                    :
                                                                                esbnMode !== '' ?
                                                                                    esbnMode === 'beforeregister' ?
                                                                                        e.instanceName.search('EsbnPage') >= 0 ?
                                                                                            'active col-sm-3 click-pointer text-center d-border-right bg-blue-white'
                                                                                        :
                                                                                            'd-none'
                                                                                    :
                                                                                    esbnMode === 'afterregister' ?
                                                                                        e.instanceName.search('EsbnxPage') >= 0 ?
                                                                                            e.instanceName.search('EsbnxPagePortfolio') >= 0 ?
                                                ...
                                                e.instanceName.search('Invboard') >= 0 ?
                                                    e.instanceName.search('tradePL') >= 0?
                                                        'col-mn-7 click-pointer text-center'
                                                        :
                                                        'col-mn-7 click-pointer d-border-right text-center'
