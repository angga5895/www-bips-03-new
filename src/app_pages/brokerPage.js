...
import { ceksizeB, GetInitialRow } from '../appConfig.js';
...
class BrokerTradeHistoryAgGrid extends React.PureComponent {
    ...
    render() {
        let formatData = { date: "", code: "", buyVol: "", buyVal: "", avgBuy: "", sellVol: "", sellVal: "", avgSell: "", netVol: "", netVal: ""}
        return (
            <>
                <div
                    ...
                    <AgGridReact
                        columnDefs={this.state.columnDefs}
                        rowData={GetInitialRow(ceksizeB("brokerTradeHistory"), formatData, this.state.rowData)}
                        defaultColDef={this.state.defaultColDef}
                        getRowHeight={this.state.getRowHeight}
                        onGridReady={this.onGridReady}
...
class BrokerTradeSummaryAgGrid extends React.PureComponent {
    ...
    render() {
        let formatData = { stock : "",buyVol : "", buyVal : "", avgBuyPrice : "", sellVol : "", sellVal : "", avgSellPrice: "", netVol : "", netVal : "" }
        ...
        return (
            <div style={{ width: "100%", height: "100%" }}>
                <div
                    ...
                    <AgGridReact
                        columnDefs={this.state.columnDefs}
                        rowData={GetInitialRow(ceksizeB("brokerTradeSummary"), formatData, this.state.rowData)}
                        defaultColDef={this.state.defaultColDef}
                        onGridReady={this.onGridReady}
                        onFirstDataRendered={this.onFirstDataRendered.bind(this)}
