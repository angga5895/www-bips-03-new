            ...
            <>
                ...
                <TableBS responsive size="sm" className="text-white my-0 bg-dark-grey card-161-1  table-striped-trans">
                    ...
                    <tr>
                        ...
                        <td className="py-1 text-primary d-border-tr-gray text-right" width="30%">19,246,883</td>
                        <td className="py-1 bg-gray-tradding d-border-tr-black" width="25%">IPO</td>
                        <td className="py-1 text-primary d-border-tr-gray text-right" width="20%">1,550</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td className="py-1 text-primary d-border-tr-gray text-left">Yes</td>
                    </tr>
                    <tr>
                        <td className="py-1 bg-gray-tradding d-border-tr-black">Corp. Action</td>
                        <td className="py-1 text-primary d-border-tr-gray text-right">No Corporation Action</td>
...
class DisclaimerStockModal extends React.Component {
    closeClick = (e) => {
...
class TableDailyTechnical extends React.PureComponent{
                ...
                <div className="row">
                    <div className="col-sm-12">
                        <table class="table table-bordered mb-0 card-topDT" style={{"width":"100%"}}>
                            <tbody>
                            <tr>
                                <td className="text-center bg-tableheader py-1 d-border-tr-gray-all" style={{"width":"19%"}}> Support 2</td>
                                <td className="text-center bg-tableheader py-1 d-border-tr-gray-all" style={{"width":"19%"}}>Support 1</td>
                                <td className="text-center bg-tableheader py-1 d-border-tr-gray-all">Research View</td>
                                <td className="text-center bg-tableheader py-1 d-border-tr-gray-all" style={{"width":"19%"}}>Resistance 1</td>
                                <td className="text-center bg-tableheader py-1 d-border-tr-gray-all" style={{"width":"19%"}}>Resistance 2</td>   
                            </tr>
                            <tr>
                                <td className="text-center bg-gray-tradding py-1 d-border-tr-black">12,001</td>
                                <td className="text-center bg-gray-tradding py-1 d-border-tr-black">12,923</td>
                                <td className="text-center bg-gray-tradding py-1 d-border-tr-black">
                                        <span class="f-12 text-danger">BUY</span>/
                                        <span class="f-12 text-warning">NEUTRAL</span>/
                                        <span class="f-12 text-success">SELL</span>
                                    <p class="text-xs text-left text-blue click-pointer" >*<i onClick={this.buttonClickStockDisclaimer}><u>Disclaimer</u></i></p></td>
                                <td className="text-center bg-gray-tradding py-1 d-border-tr-black">12,001</td>
                                <td className="text-center bg-gray-tradding py-1 d-border-tr-black">12,923</td>
                               </tr>
                            </tbody>
                    ...
                    <div className="col-sm-12 mt-1">
                        <table class="table table-bordered tb-dailytech">
                            ...
                            <tr>
                                ...
                                <td className="text-right  py-2 d-border-tr-gray text-info">4,75</td>
                                <td className="bg-gray-tradding py-2 d-border-tr-black" width="30%" >3M Avg Turnover(Bn)</td>
                                <td className="text-right py-2 d-border-tr-gray text-info">41,45</td>
                            </tr>
                            <tr>
                                <td className="bg-gray-tradding py-2 d-border-tr-grey">Remark</td>
                                <td colspan="3" className="py-2 d-border-tr-grey text-left">
                                    <ul>
                                        <li>Bisa beli di level 12,232 - 13,232 dengan level jual 12.800 - 12.920</li>
                                    </ul>
                                </td>
                            </tr>
                            </tbody>
...
class StockSpecialNotation_Base extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            tabNumber: 1,
...
class SpecialNotationAgGrid extends React.Component {
    constructor(props) {
        super(props);
        const self = this;
        const s = props.size;
        this.state = {
            ...
            rowData: [
                ...
                {
                    code: "PGJO",
                    company: "PT Tourindo Guide Indonesia Tbk",
                    notation: "D-L-Y",
                    board: "Watchlist",
                },
                {
    ...
    render(){
        return(
            <>
                ...
                <div className="col-sm-12 px-0 py-0 mx-0 row">
                    <div className="col-sm-6 pr-3 pl-0 f-12">
                        <TableInfoTransaction lotshare="stockInfoBuy2"/>
                    </div>
...
class BuyPage2 extends React.Component{
    constructor(props) {
        super(props);
    }
    componentDidMount(){
...
class SpecialNotationModal extends React.Component {
    constructor(props) {
        super(props);
        };
    handleOnClick = (e) => {
               ...
               <div className={"col-sm-12 px-0 pt-0"}>
                    ...
                    <thead className="bg-tableheader">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Bankruptcy filing against the company</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="text-center">M</td>
                                                        <td>Moratorium of debt payment</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Adverse opinion of the audited financial report</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="text-center">D</td>
                                                        <td>Disclaimer opinion of the audited financial report</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="text-center">L</td>
                                                        <td>Late submission of financial report</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="text-center">S</td>
                                                        <td>No sales based on latest financial report</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="text-center">C</td>
                                                        <td>Lawsuit against Listed Company, its subsidiary, and/or member of Board of Directors and Board of Commissioners of Listed Company which has Material impact</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="text-center">Q</td>
                                                        <td>Restriction of business activity of Listed Company and/or its subsidiary by regulator</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="text-center">Y</td>
                                                        <td>Listed Company has not held Annual General Meeting of Shareholders until 6 (six) months after the end of previous year</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="text-center">F</td>
                                                        <td>Administrative sanction from OJK due to minor offense</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="text-center">G</td>
                                                        <td>Administrative sanction from OJK due to moderate offense</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="text-center">V</td>
                                                        <td>Administrative sanction from OJK due to serious offens</td>
                                                    </tr>
                                                    </tbody>                                                    
                                                </table>
                </div>
...
export { CustomFrameHeaderStock, BuyPage , AmendGroupNameAgGrid, AmendGroupCodeAgGrid, AddGroupCodeAgGrid, BuyModal, SellModal, RegisterAmendModal, SpecialNotationModal, BuyPage2, BuyPageOld };
export {
