...
class Modal_automatic_order extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isChecked: false,
        ...
        return (
            <>
                    ...
                    <div className="form-group row">
                        <div className="col-sm-6 text-left rborder-blue">
                            <ul>
                                ...
                                <li>Parameter kondisi <b>Automatic order</b> yang belum tereksekusi sebelum terjadinya masalah akan dilanjutkan setelah fitur <b>Automatic Order</b> diaktifkan kembali oleh <b>BAHANA SEKURITAS</b>.
</li>
                                <li>Pengguna mengerti dan menyanggupi untuk tidak menggunakan <b>Automatic Order</b> untuk memanipulasi pasar.
</li>
                                <li>Fitur <b>Automatic order</b> tidak menjamin akan menjadi trade (match) ketika order terkirimkan secara otomatis dengan harga dan volume yang telah ditetapkan.
</li>
                                <li>Diskripensi data yang dapat diakibatkan oleh kondisi jaringan dan lainnya dapat menyebabkan order tidak terkirim atau terlambat terkirim.
</li>
                            </ul>
                        </div>
                        <div className="col-sm-6 text-left">
                            <ul>
                                ...
                                <li>User undertakes not use <b>Automatic Orders</b> to manipulate the market.
</li>
                ...
                <div className="text-center col-sm-12">
                        <button className="btn btn-primary btn-sm col-sm-2" onClick={this.closeClick}>OK</button>
                    </div>
            </>
        );
    }
}
class Modal_terms_condition extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isChecked: false,
    ...
    render() {
        return (
            <>
                ...
                <div className="text-center col-sm-12">
                        <button className="btn btn-primary btn-sm col-sm-1" onClick={this.closeClick}>OK</button>&nbsp;&nbsp;
        ...
        return(
            <>
                ...
                <div className="bg-dark-grey d-border card-520">
                    <div className="row">
                        <span
                            onClick={this.buttonClickInformation} 
                            id={"triggerInformation"}>
                        </span>
                        ...
                        <div className="col-sm-6 f-12 pt-3">
                            ...
                            <div className="col-sm-12 row mb-3 pr-0">
                                ...
                                <div className="col-sm-3 pl-1" style={{marginTop:"1px"}}>
                                    <button className="btn btn-primary"  onClick={( 1 < 0 ) ?this.buttonClickTermsCondition:this.handleRestrict}>
                                        Save Settings
                                    </button>
                                </div>
                            </div>
            ...
            columnDefs: [
                ...
                { field: "on", headerName: "#", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    ...
                    cellRendererFramework: function(params) {
                        ...
                        if(cmd){
                            return <button className="btn-cellOn btn btn-sm btn-primary mx-1 f-9" onClick={() => self.onUpdateItem(ruleID) }> Enabled </button>
                        }else{
                            return <button className="btn-cellOn btn btn-sm btn-dark mx-1 f-9" onClick={() => self.onUpdateItem(ruleID) }> Disabled </button>
                        }
                    },
            ...
            <div className="container-fluid px-2 mx-0 pb-0 pt-1 card-527">
                ...
                <div id={"orderListPin"}>
                    ...
                    <div className="row f-12 contentOrderList d-none">
                        <input type="hidden" id="tempNotation"/>
...
class OrderHistoryAgGrid extends React.PureComponent {
    constructor(props) {
        ...
        this.state = {
            columnDefs: [
                { field: "date", headerName: "Created Date", sortable: true, filter: "agTextColumnFilter", resizable: true, comparator: stringComparator,
                ...
                { field: "marketOrderID", headerName: "#Market Order.ID", sortable: true, filter: "agTextColumnFilter", resizable: true, comparator: stringComparator,
                    width: s=="s49"?220:s=="s50"?200:s=="s67"?170:s=="s75"?160:160,
                    cellClass : function (params) {
                        return "text-right grid-table d-border-aggrid-right f-12";
                    },},
                { field: "serverOrderID", headerName: "#Server Order.ID", sortable: true, filter: "agTextColumnFilter", resizable: true, comparator: stringComparator,
                    width: s=="s49"?210:s=="s50"?200:s=="s67"?155:s=="s75"?150:135,
                    cellClass : function (params) {
                        return "text-right grid-table d-border-aggrid-right f-12";
                    },},
                { field: "code", headerName: "Code", sortable: true, resizable: true, comparator: stringComparator,
                    width: s=="s49"?210:s=="s50"?200:s=="s67"?100:s=="s75"?80:75,
                    cellClass : function (params) {
                ...
                { field: "status", headerName: "Status", sortable: true, comparator: stringComparator,
                    resizable: true,
        ...
        this.state = {
            ...
            rowData: [
                { 
                    ...
                    cmd: "SELL",
                    code: "ABBA",
                    condition: "Last Price <= 2,750",
                    vol: 30,
                    value: 1300,
                    price: 44750,
                    expireDate: "04/07/2020",
                    executeStatus: "Partial Match",
                    orderStatus: "Open"
                },
            ],
            sideBar: {
        ...
        this.state = {
            columnDefs: [
                ...
                { field: "-", headerName: "#", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: 35, comparator: stringComparator,
                    minWidth: 35,
                ...
                { field: "time", headerName: "Time", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?150:100, minWidth:100, comparator: stringComparator,
                    cellClass : function (params) {
                ...
                { field: "vshares", headerName: "Vol. Shares", sortable: true, filter: "agNumberColumnFilter",
                    resizable: true, width:120, minWidth:120, comparator: integerComparator,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },
                { field: "price", headerName: "Price", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                    width: 86, minWidth: 86, comparator: integerComparator,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },
                { field: "mlot", headerName: "Match Vol. Lot", sortable: true, filter: "agNumberColumnFilter",
                    resizable: true, width: 130, minWidth:130, comparator: integerComparator,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },
                { field: "mshares", headerName: "Match Vol. Shares", sortable: true, filter: "agNumberColumnFilter",
                    resizable: true, width: 140, minWidth:140, comparator: integerComparator,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },
                { field: "avgmatchprice", headerName: "Avg. Match Price", sortable: true, filter: "agNumberColumnFilter",
                    resizable: true, width: s=="s49"?140:135, minWidth:135, comparator: integerComparator,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },
                { field: "amount", headerName: "Amount", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                    width: s=="s49"?120:100, minWidth:100, comparator: integerComparator,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },
