    ...
    constructor(props) {
        ...
        this.state = {
            columnDefs: [
                ...
                { field: "fbuy", headerName: typegrid != "indices"?"F.Buy(Val)":"F.Buy", resizable: true, filter: "agNumberColumnFilter",
                    width: s=="s49"?180:s=="s50"?165:s=="s75"?170:140, minWidth: 140,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    } },
                { field: "fsell", headerName: typegrid != "indices"?"F.Sell(Val)":"F.Sell", filter: "agNumberColumnFilter",
                    resizable: true, width: s=="s49"?180:s=="s50"?165:s=="s75"?170:140, minWidth: 140,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    } },
                { field: "fnet", headerName: typegrid != "indices"?"F.Net(Val)":"F.Net", filter: "agNumberColumnFilter",
    ...
    constructor(props) {
        ...
        this.state = {
            columnDefs: [
                ...
                { field: "fbuy", headerName: "F.Buy (Val)", resizable: true, filter: "agNumberColumnFilter",
                    width: s=="s49"?170:s=="s50"?160:s=="s67"?140:s=="s75"?132:122,
                    minWidth: 122,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    } },
                { field: "fsell", headerName: "F.Sell (Val)", resizable: true, filter: "agNumberColumnFilter",
