...
import {Input, Popup, Dropdown, Radio, Checkbox} from 'semantic-ui-react';
                                    ...
                                    <div id="detailPortofolio" className="d-none">
                                        <div className="card-header card-header-investment bg-grey h-40">
                                            <div className="row col-sm-12 px-0 mx-0 py-1">
                                                ...
                                                <div className="col-sm-3 px-4 mx-0 f-14">
                                                    Market Val : <span className="text-primary">15,234,000</span>
                                                </div>
                                                <div className="col-sm-3 px-4 mx-0 f-14">
                        ...
                        <div className="col-sm-10 px-0">
                            ...
                            <div className="col-sm-12 card-221 px-0">
                                ...
                                <table className="table text-white d-border-table bg-dark-grey table-sm table-borderless mb-0 card-194">
                                    ...
                                    <tr>
                                        <td className="no-wrap bg-gray-tradding d-border-tr-black py-1">Exercise</td>
                                        <td className="d-border-tr-gray-all text-right py-1">0</td>
                                        <td className="d-border-tr-gray-all text-right py-1">0</td>
                                        <td className="d-border-tr-gray-all text-right py-1">10,000,000</td>
                                    </tr>
...
class ConfirmationExerciseRequest extends React.Component {
    componentDidMount(){
    ...
    render() {
        return (
                ...
                <div className="col-sm-12 text-white px-0 mx-0 f-12">
                    <div className="col-sm-12 row mx-0 px-0">
                        ...
                        <div className="col-sm-6 px-0 mx-0 text-right">
                            (Exercise No: <span className="text-primary">#123456</span>)
                        </div>
                    </div><br/>
                    <div className="col-sm-12 mx-0 px-0">
                        <Table size="sm" responsive borderless className="text-white">
                            ...
                            <tr>
                                <td>Excersice Ratio</td>
                                <td>:</td>
                                <td>10</td>
                            </tr>
                            <tr>
                                <td>Excersice Price</td>
                                <td>:</td>
                                <td>12,000</td>
                            </tr>
                            <tr>
                                <td>Excersice Quantity</td>
                                <td>:</td>
                                <td >10</td>
                            </tr>
                            <tr>
                                <td>Excersice Value</td>
                                <td>:</td>
                                <td>12,000</td>
                            </tr>
                            <tr>
            ...
            <div className="col-sm-12 text-center f-13 mx-0 px-0">
                Do you want to excercise this RIGHT?</div><br/>
                <div className="col-sm-12 row mx-0 px-0">
...
class ExcersiceListAgGrid extends React.PureComponent {
    constructor(props) {
        super(props);
        const self = this;
        ...
        this.state = {
            columnDefs: [
                { field: "no", headerName: "No", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?180:s=="s50"?180:s=="s67"?170:s=="s75"?130:s=="s80"?80:70, comparator: integerComparator,
                    minWidth: 70,
                    ...
                    width: s=="s49"?180:s=="s50"?160:s=="s75"?120:100, minWidth: 100, comparator: dateComparator,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-left f-12";
                    }, suppressSizeToFit: true
                },{ field: "exrid", headerName: "Exercise ID", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                    width: s=="s49"?240:s=="s50"?220:s=="s67"?190:s=="s75"?160:s=="s80"?110:100, comparator: integerComparator,
                    minWidth: 100,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-center f-12";
                    },
                },{ field: "right_code", headerName: "Exercise Code", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                    width: s=="s49"?250:s=="s50"?200:s=="s67"?180:s=="s75"?170:s=="s80"?150:130, comparator: integerComparator,
                    minWidth: 130,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-center f-12";
                    },
                },{ field: "price", headerName: "Exercise Price", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?230:s=="s50"?200:s=="s67"?170:s=="s75"?150:s=="s80"?130:120, comparator: stringComparator,
                    minWidth: 120,
                    valueFormatter: (params)=>thousandSeparator(params.value),
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },{ field: "fee", headerName: "Exercise Fee", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?230:s=="s50"?190:s=="s67"?170:s=="s75"?160:s=="s80"?150:135, comparator: integerComparator,
                    minWidth: 150,
                    valueFormatter: (params)=>thousandSeparator(params.value),
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    ...
                    width: s=="s67"?160:s=="s75"?140:s=="s90"?160:140, minWidth: 140, comparator: dateComparator,
                    valueFormatter: (params)=>thousandSeparator(params.value),
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },{ field: "quantity_stock", headerName: "Stock Qty (shr)", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s90"?160:s=="s75"?140:140, minWidth: 140, comparator: dateComparator,
                    valueFormatter: (params)=>thousandSeparator(params.value),
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },{ field: "value", headerName: "Value", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?200:s=="s50"?180:s=="s67"?150:s=="s75"?155:s=="s80"?125:90, minWidth: 90, comparator: stringComparator,
                    valueFormatter: (params)=>thousandSeparator(params.value),
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },{ field: "amount", headerName: "Amount", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?210:s=="s50"?190:s=="s67"?150:s=="s75"?150:s=="s80"?135:120, minWidth: 110, comparator: stringComparator,
                    valueFormatter: (params)=>thousandSeparator(params.value),
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-right f-12";
                    },
                },{ field: "status", headerName: "Status", sortable: true, resizable: true,
                    width: s=="s49"?210:s=="s50"?180:s=="s67"?160:s=="s75"?150:s=="s80"?145:125, minWidth: 125, comparator: stringComparator,
                    cellClass : function (params) {
                        return " grid-table d-border-aggrid-right text-center f-12";
                    },
    ...
    render () {
        ...
        return (
            <>
                ...
                <AppFrameAction ref="frameAction" />
                <div className="container-fluid px-1 f-12" id="RightWarrantPIN">
                    <VerifyPINPortofolio pos="rightWarrant"/>
                </div>
                <div className="container-fluid px-1 f-12 d-none" id="ContentRightWarrant">
                    ...
                    <div className="col-sm-12 px-0" style={paddingParagraph}>
                        ...
                        <div className="cssmenu col-sm-6 mx-0 px-0 h-45">
                            <ul className={"d-border-top d-border-left d-border-right"}>
                                <li className={ this.state.activeTab === '1' ? 'd-border-right active click-pointer col-sm-6 px-0 mx-0 f-12 text-center' : 'd-border-right text-white click-pointer col-sm-6 px-0 mx-0 f-12 text-center' } onClick={() => { this.toggle('1'); }}><a><span className="f-11">&nbsp; EXERCISE REQUEST</span></a></li>
                                <li className={ this.state.activeTab === '2' ? 'd-border-right active click-pointer col-sm-6 px-0 mx-0 f-12 text-center' : 'd-border-right text-white click-pointer col-sm-6 px-0 mx-0 f-12 text-center' } onClick={() => { this.toggle('2'); }}><a><span className="f-11">&nbsp; EXERCISE LIST</span></a></li>
                            </ul>
                        </div>
                        <div className="col-sm-12 px-4 bg-black-trading pt-0 d-border card-472">
                                        ...
                                        <div className="col-md-8 pl-0">
                                            ...
                                            <table className="table text-white d-border-table table-sm table-borderless">
                                                <tr>
                                                    ...
                                                    <td width="40%" className="text-left ver-center py-0">ASTRA AGRO LESTARI Tbk.</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className=" text-right pb-0">
                                                        <NumberInput className="z0" idclassname="ExerciseRequestInput" defaultValue={"0"} />
                                                    </td>  
    ...
    constructor(props) {
        ...
        this.state = {
            columnDefs: [
                ...
                },{ field: "acqAvgBuyPrice", headerName: "Acq. Avg. Buy Price", sortable: true, filter: "agNumberColumnFilter", resizable: true,comparator: integerComparator,
        ...
        this.state = {
            ...
            columnDefs: [
                ...
                { field: "lastprice", headerName: "Last Price", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                    width: s=="s49"?200:s=="s50"?180:s=="s67"?160:s=="s75"?154:110, minWidth: 110,comparator: integerComparator,
                    cellClass : function (params) {
                ...
                { field: "shares", headerName: "Shares", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                    width: s=="s49"?160:s=="s50"?150:s=="s67"?110:100, minWidth: 100, comparator: integerComparator,
                    cellClass : function (params) {
                        var pl = params.data.pl;
                        return pl.includes('-') === true ? "text-danger text-right grid-table f-12 d-border-aggrid-right":
                            "text-success text-right  grid-table f-12 d-border-aggrid-right";
                ...
                { field: "stockval", headerName: "Stock Val", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                    width: s=="s49"?250:s=="s50"?245:s=="s67"?220:s=="s75"?190:120, comparator: integerComparator,
                    minWidth: 120,
                    cellClass : function (params) {
                        var pl = params.data.pl;
                        return pl.includes('-') === true ? "text-danger text-right grid-table f-12 d-border-aggrid-right":
                ...
                { field: "pl", headerName: "P/L %", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?230:s=="s50"?190:s=="s67"?180:s=="s75"?160:150, comparator: integerComparator,
                    minWidth: 150,
                    cellClass : function (params) {
                        var pl = params.data.pl;
                        return pl.includes('-') === true ? "text-danger text-right grid-table f-12 d-border-aggrid-right":
                ...
                minWidth:150,
                cellClass : function (params) {
                    if(params.data.notation == ""){
                        return " grid-table text-primary d-border-aggrid-right text-center f-12";
                    }else{
                        return " grid-table text-primary d-border-aggrid-right text-center f-12 click-pointer";
                    } },
                cellRenderer : function (params) {
                    ...
                    if(params.data.notation === ""){
                        ...
                        eDiv.innerHTML = '<span class="btn-cellorder px-1">' +notation+ '</span>';
                        ...
                        function clickNotationDetail(){
                            self.refs.frameAction.showModal({
                                ...
                                onOpen: document.getElementById("tempNotation").value = params.data.notation,
                                onClose: (result) => {console.log('Modal 1 result = ', result)}
                            })
                        }
        ...
        this.state = {
            columnDefs: [
                ...
                { field: "code", headerName: "Code", sortable: true, resizable: true,
                    width: s=="s49"?250:s=="s50"?200:120, minWidth: 120, comparator: stringComparator,
                    cellClass : function (params) {
                        return "text-left grid-table f-12 d-border-aggrid-right";
                    }
                },
                ...
                { field: "amount", headerName: "Amount", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                    width: s=="s49"?160:s=="s50"?150:120, minWidth: 120,  comparator: integerComparator,
                    cellClass : function (params) {
                        return " text-right grid-table f-12 d-border-aggrid-right";
                    }
                },
                { field: "time", headerName: "Time", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?200:s=="s50"?190:120, minWidth: 120,  comparator: stringComparator,
                    cellClass : function (params) {
                        return " text-right grid-table f-12 d-border-aggrid-right";
                    }
                }
        ...
        this.state = {
            columnDefs: [
                ...
                { field: "code", headerName: "Code", sortable: true, resizable: true,
                    ...
                    width: s=="s49"?140:s=="s50"?120:90, minWidth:90,comparator: stringComparator,
                    cellClass : function (params) {
                        return "text-left grid-table d-border-aggrid-right f-12";
                    }
                },{ field: "mkt", headerName: "Mkt", sortable: true, resizable: true,
                    width: s=="s49"?170:s=="s50"?150:100, minWidth: 100,comparator: stringComparator,
                    cellClass : function (params) {
                        return "text-center grid-table d-border-aggrid-right f-12";
                    },},
                { field: "vol", headerName: "Vol", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                    width: s=="s49"?170:s=="s50"?150:110, minWidth:110,comparator: integerComparator,
                    cellClass : function (params) {
                        return "text-right grid-table d-border-aggrid-right f-12";
                    },},
                { field: "price", headerName: "Price", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                ...
                { field: "leaveVolC", headerName: "Leave Vol", sortable: true, filter: "agNumberColumnFilter", resizable: true,
                    width: s=="s49"?180:s=="s50"?160:130, minWidth:130,comparator: integerComparator,
                    cellClass : function (params) {
                        return "text-right grid-table d-border-aggrid-right f-12";
                    },},
                ...
                { field: "time", headerName: "Time", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?160:s=="s50"?155:100, minWidth:100,comparator: integerComparator,
                    cellClass : function (params) {
                        return "text-left grid-table d-border-aggrid-right f-12";
                    },},
                { field: "rejectreason", headerName: "Reject Reason", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?160:s=="s50"?155:130, minWidth:130,comparator: stringComparator,
                    cellClass : function (params) {
                        return "text-left grid-table d-border-aggrid-right f-12";
                    },},
                { field: "userOrderC", headerName: "User Order", sortable: true, filter: "agTextColumnFilter", resizable: true,
                    width: s=="s49"?170:s=="s50"?160:130, minWidth:130,comparator: stringComparator,
                    cellClass : function (params) {
                        return "text-left grid-table d-border-aggrid-right f-12";
                    },},
