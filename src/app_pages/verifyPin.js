        ...
        if(this.state.value.length >= '6' || this.props.pinStatus === true){
            if(this.props.pinStatus === true) {
                ...
                if (this.props.tipe === 'buy'){
                    ...
                    $("#AutOrderPIN").addClass("d-none");
                    $("#ContentAutOrder").removeClass("d-none");
                    $("#ContentAutOrder").addClass("d-block");

                    $("#AutSentOrderPIN").addClass("d-none");
                    $("#ContentSentAutOrder").removeClass("d-none");
                    $("#ContentSentAutOrder").addClass("d-block");

                    $("#AutExpOrderPIN").addClass("d-none");
                    $("#ContentExpAutOrder").removeClass("d-none");
                    $("#ContentExpAutOrder").addClass("d-block");

                    $("#RightWarrantPIN").addClass("d-none");
                    $("#ContentRightWarrant").removeClass("d-none");
                    $("#ContentRightWarrant").addClass("d-block");
                }else if (this.props.tipe === 'esbnregister'){
                    console.log(this.props.updateStatusEsbn(3));
                    this.refs.frameAction.closeModal(100);
                    this.refs.frameAction.switchPage("EsbnxPageTransaction","/esbnPage");
                    setTimeout(()=>{
                        console.log(this.props.updateStatusEsbn(3));
                    }, 50);
                } else {
