                    ...
                    <div className="row" id={"formInputIndicators" + this.state.stockType} >
                        <div className="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <ul className="list list-unstyled list-nav" id={"indicatorNavPanel" + this.state.stockType} style={styleses}>
                                <div className="form-inline" width="100%">
                                    ...
                                    <div className={this.state.stockType == "chrtStock" ? 'form-group ml-3' : 'form-group d-none ml-3' } width="100%">
                                        <table className="table mb-0 h-35 table-sm table-borderless tb-right-info f-13">
                                            <thead></thead>
                                            <tbody className="d-border-top d-border-bottom">
                                                <tr>
                                                <td>Last:<span className="text-danger"> 1.110</span></td>
                                                <td>Support 2:<span className="text-danger"> 1.105</span></td>
                                                <td>Support 1:<span className="text-danger"> 1.100</span></td>
                                                <td>Resistance 1:<span className="text-success"> 1.115</span></td>
                                                <td>Resistance 2:<span className="text-success"> 1.120</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
